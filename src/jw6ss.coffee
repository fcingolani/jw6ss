...
# The JW6SS Class is our namespace-like container, to avoid global scope
# pollution.
...
class JW6SS.Reporter
  ...
  # To create a `Reporter` instance, you **have** to provide a JW Player instance (as
  # returned by `jwplayer()` and a `ns_.StreamSense` instance.
